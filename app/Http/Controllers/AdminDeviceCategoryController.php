...
class AdminDeviceCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            ...
            'name.unique' => 'Tên này đã bị trùng với loại thiết bị khác.',
        ...
        Alert::toast('Tạo loại thiết bị mới thành công!', 'success', 'top-right');
    ...
    public function destroy($id)
    {
        ...
        Alert::toast('Xóa loại thiết bị thành công!', 'success', 'top-right');
        return redirect()->route('admin.device_categories.index');
    }
