    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                    <form class="form-horizontal" method="post" action="{{ url('/errors') }}" name="add_error" id="add_error" novalidate="novalidate">{{ csrf_field() }}
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group date" id="detection_time" name="detection_time" data-target-input="nearest">
                                        <input type="text" id="detection_time" name="detection_time" class="form-control datetimepicker-input" data-target="#detection_time"/>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group date" id="recovery_time" name="recovery_time" data-target-input="nearest">
                                        <input type="text" id="recovery_time" name="recovery_time" class="form-control datetimepicker-input" data-target="#recovery_time"/>
